const DisplaySec = () => {
  return (
    <div className="grid grid-cols-2 items-center md:grid-cols-1">
      ...
      <div className="w-[100%]">
        <lottie-player src="https://lottie.host/fdcd7df3-0c72-43f0-8346-12bebd56c714/JwyRbDNvNA.json" background="#FFFFFF" speed="1" loop autoplay direction="1" mode="normal"></lottie-player>
      </div>

      <div className="info space-y-3 md:px-9 ">
        <h1>Hi, I am John </h1>
        <p className="text-pink-700">Some Dev, Freelancer, Rounder</p>
